...
class ClassFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        professorEditText.addTextChangedListener{
            viewModel.setProfessorName(it.toString())
        }
        classNameEditText.addTextChangedListener {
            viewModel.setClassName(it.toString())
        }
